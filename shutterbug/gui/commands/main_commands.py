...
class RemoveImagesCommand(QUndoCommand):
    ...
    def __init__(
        ...
        for name in image_names:
            if name in main_window.fits_data:
                image_paths.append(main_window.fits_data[name].filepath)
...
def remove_images(
    image_names: List[Path], main_window: MainWindow, viewer: Viewer, outliner: Outliner
):
